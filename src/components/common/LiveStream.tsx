            ...
            <section id='liveStream' className="bg-gradient-to-r from-primary-dark to-primary">
                <div className='px-6 py-12 max-w-container 2xl:max-w-container-xl mx-auto lg:flex'>
                    ...
                    <div className='lg:block lg:w-1/2 font-sm mt-6 lg:mt-0'>
                        ...
                        <iframe className='h-[40vh] w-full' width="965" height="543" src="https://youtube.com/embed/M_ok3CCehgE" title="Calciosplash 2024 - Day 5" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture;"></iframe>
                    </div>
