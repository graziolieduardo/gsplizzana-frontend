                ...
                <form onSubmit={handleSubmit(onSubmit)} className=" py-12 px-12 md:px-10 rounded mt-4  bg-white border">
                    ...
                    <div className="mt-4 md:flex  gap-x-4">
                        ...
                        <div>
                            ...
                            <input{...register("username", {required: '- Il campo Username è obbligatorio'})} type="text" id="username" className={ `${errors.username? 'focus:outline-red-500 border-2 border-red-500' : 'focus:outline-primary'} rounded bg-gray-100 px-2 py-1 w-full`} placeholder="luiginho" />
                    ...
                    <div className="mt-4 md:flex gap-x-4">
                        ...
                        <div className="flex-1">
                            ...
                            <input{...register("password_confirmation", {required: '- Conferma la password',  validate: value => value === watch('password') || '- Le Password nono sono uguali'})} type="password" id="password_confirmation" className={ `${errors.password_confirmation? 'focus:outline-red-500 border-2 border-red-500' : 'focus:outline-primary'} rounded bg-gray-100 px-2 py-1 w-full`} placeholder="confirm-password" />
                    ...
                    <div className="text-sm text-center mt-1">Gia registrato? <Link href="/login" className="text-blue-500 underline">Login</Link></div>
                </form>
            </div>
        </div>
    )
