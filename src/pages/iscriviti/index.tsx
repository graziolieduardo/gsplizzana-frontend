                ...
                <form onSubmit={handleSubmit(onSubmit)} className=" py-12 px-12 md:px-10 rounded mt-4  bg-white border">
                    ...
                    <div className="mt-6 md:flex gap-x-4">
                        ...
                        <div className="flex-1">
                            ...
                            })} type="text" id="name" className={ `${errors.name? 'focus:outline-red-500 border-2 border-red-500' : ''} rounded bg-gray-100 px-2 py-1 w-full focus:outline-primary`} placeholder="Luigi" />
                        ...
                        <div className="flex-1">
                            ...
                            })} type="text" id="surname" className={ `${errors.surname? 'focus:outline-red-500 border-2 border-red-500' : ''} rounded bg-gray-100 px-2 py-1 w-full focus:outline-primary`} placeholder="Buffon" />
                    ...
                    <div className="mt-4 md:flex  gap-x-4">
                        ...
                        <div>
                            ...
                            <input{...register("email", {required: '- the field email is required', pattern: {value: /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i, message: '- Scegli un email valido'} })} type="text" id="email" className={ `${errors.email? 'focus:outline-red-500 border-2 border-red-500' : ''} rounded bg-gray-100 px-2 py-1 w-full focus:outline-primary`} placeholder="luigibuffon@gmail.com" />
                        ...
                        <div>
                            ...
                            <input{...register("username", {required: '- the field username is required'})} type="text" id="username" className={ `${errors.username? 'focus:outline-red-500 border-2 border-red-500' : ''} rounded bg-gray-100 px-2 py-1 w-full focus:outline-primary`} placeholder="luiginho" />
                        ...
                        <div>
                            ...
                            <input{...register("birthdate", {required: '- Scegli una data'})} type="date" id="birthdate" className={ `${errors.birthdate? 'focus:outline-red-500 border-2 border-red-500' : ''} rounded bg-gray-100 px-2 py-1 w-full focus:outline-primary`} placeholder="birthdate" />
                    ...
                    <div className="mt-4 md:flex gap-x-4">
                        ...
                        <div className="flex-1">
                            ...
                            <input{...register("password", {required: '- scegli una password'})} type="password" id="password" className={ `${(errors.password || errors.password_confirmation?.message)? 'focus:outline-red-500 border-2 border-red-500' : ''} rounded bg-gray-100 px-2 py-1 w-full focus:outline-primary`} placeholder="password" />
                        ...
                        <div className="flex-1">
                            ...
                            <input{...register("password_confirmation", {required: '- rimeti la password',  validate: value => value === watch('password') || '- Le password sono diverse'})} type="password" id="password_confirmation" className={ `${errors.password_confirmation? 'focus:outline-red-500 border-2 border-red-500' : ''} rounded bg-gray-100 px-2 py-1 w-full focus:outline-primary`} placeholder="confirm-password" />
