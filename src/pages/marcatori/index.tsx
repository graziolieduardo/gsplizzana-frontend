...
export default function Index() {
    ...
    const fetchScorers = async () => {
        const res = await axios.get(`${process.env.NEXT_PUBLIC_GSPLIZZANA_API_ENDPOINT}scorers`, { params: { gender: activeComp === 'maschile' ? 'male' : 'female' } });
        return res.data;
    }

    // GET SINGLE ORDER
    const { data: scorers, isLoading } = useQuery(['scorers', activeComp],
        () => fetchScorers(),
        {
